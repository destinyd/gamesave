...
public class GetApplicationOfSystem extends Activity implements
		OnItemClickListener {
...
//		apps = loadAppInfomation(this);
		...
		mAdapter = new InstalledPackageAdapter(this, myApps);
...
//	}
	...
	public void onItemClick(AdapterView<?> parent, View view, int position,
			long id) {
		Intent intent = new Intent(GetApplicationOfSystem.this,
				AppController.class);
...
//				.getPackageName());
		intent.putExtra("pName", myApps.get(position).applicationInfo.loadLabel(this.getPackageManager()));
